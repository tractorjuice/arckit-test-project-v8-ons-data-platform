...
| **Owner** | ONS Data Protection Officer |
| **Reviewed By** | PENDING |
| **Approved By** | PENDING |
| **Distribution** | Project Team, Data Protection Officer, Chief Data Officer, Security Team |
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-11-12 | ArcKit AI | Initial DPIA assessment from `/arckit.dpia` command | PENDING | PENDING |
| 1.1 | 2026-01-26 | ArcKit AI | Updated to template v0.11.2 format - enhanced Document Control, Revision History | PENDING | PENDING |
...
| Role | Name | Signature | Date |
|------|------|-----------|------|
| Data Controller | Chief Data Officer, ONS | PENDING | PENDING |
| Data Protection Officer | ONS Data Protection Officer | PENDING | PENDING |
| Senior Responsible Owner | Chief Data Officer, ONS | PENDING | PENDING |
