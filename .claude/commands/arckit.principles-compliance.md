...
Generate a comprehensive compliance assessment document that measures adherence to each architecture principle defined in `.arckit/memory/architecture-principles.md`. The assessment includes RAG status (Red/Amber/Green), evidence links, gaps, and actionable recommendations.
...
- `projects/{project-dir}/requirements.md` - Requirements to assess against principles
...
- `projects/{project-dir}/tcop-assessment.md` - Technology Code of Practice compliance
- `projects/{project-dir}/secure-by-design.md` - Security assessment
- `projects/{project-dir}/data-model.md` - Data architecture
- `projects/{project-dir}/traceability-matrix.md` - Requirements traceability
...
**Dynamic Principle Extraction**: Do NOT assume a fixed number of principles. Organizations may define 5, 10, 20, or more principles. Extract ALL principles found in `architecture-principles.md` dynamically.
...
```bash
if [ ! -f .arckit/memory/architecture-principles.md ]; then
...
Read `.arckit/memory/architecture-principles.md` and extract ALL principles found.
...
- `tcop-assessment.md` - TCoP point scores
- `secure-by-design.md` - NCSC CAF assessment results
- `mod-secure-by-design.md` - MOD CAAT assessment
- `ai-playbook-assessment.md` - AI principles scores
- `atrs-record.md` - Algorithmic transparency

**From other artifacts**:
- `data-model.md` - Entity-relationship diagram, GDPR compliance
- `traceability-matrix.md` - Requirements coverage
- `servicenow-design.md` - Operational design
- `stakeholder-drivers.md` - Business drivers
- `risk-register.md` - Risk mitigation plans

### 5. Assess Each Principle

**FOR EACH principle extracted** from architecture-principles.md:
...
- Does requirements.md address this principle?
...
- Example: Security principle → Check secure-by-design.md findings
...
📄 **Document**: projects/{project-dir}/principles-compliance-assessment-{YYYY-MM-DD}.md
...
[IF principle defines validation gates in architecture-principles.md:]
...
- ⚪ No validation gates defined for this principle in architecture-principles.md
...
- ✅ `projects/{project-dir}/tcop-assessment.md` - {DATE} - {N} points assessed
- ✅ `projects/{project-dir}/secure-by-design.md` - {DATE} - {N} controls assessed
- ✅ `projects/{project-dir}/data-model.md` - {DATE} - {N} entities
- ✅ `projects/{project-dir}/traceability-matrix.md` - {DATE}
...
1. **Commit to Git** (if project is git-initialized):
   ```bash
   git add projects/{project-dir}/principles-compliance-assessment-{date}.md
...
1. **Dynamic Extraction**: NEVER assume 16 principles exist. Extract however many are in architecture-principles.md.
